...
Repositório criado para a entrega da Lista de Exercícios II da disciplina de Usabilidade, Desenvolvimento Web, Mobile e Jogos (UDWMJ)[cite: 2].
...
## Como Executar
Faça o clone deste repositório e abra o arquivo `index.html` em qualquer navegador de internet.
